...
namespace NaniTrader.Blazor.Pages
{
    public partial class Authors
    {
        ...
        {
            CanCreateAuthor = await AuthorizationService.IsGrantedAsync(NaniTraderPermissions.Authors.Create);

            CanEditAuthor = await AuthorizationService.IsGrantedAsync(NaniTraderPermissions.Authors.Edit);

            CanDeleteAuthor = await AuthorizationService.IsGrantedAsync(NaniTraderPermissions.Authors.Delete);
        }

    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ExchangeIdentifier = table.Column<int>(type: "int", nullable: false),
                    SecuritiesProvider = table.Column<int>(type: "int", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppFyersCredentials", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppFyersCredentials_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppEquities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppEquities_Exchanges_ExchangeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppEquityFutures", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppEquityFutures_Exchanges_ExchangeId",
                        column: x => x.ExchangeId,
                        principalTable: "Exchanges",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppEquityOptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppEquityOptions_Exchanges_ExchangeId",
                        column: x => x.ExchangeId,
                        principalTable: "Exchanges",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppETFs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppETFs_Exchanges_ExchangeId",
                        column: x => x.ExchangeId,
                        principalTable: "Exchanges",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppIndexes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppIndexes_Exchanges_ExchangeId",
                        column: x => x.ExchangeId,
                        principalTable: "Exchanges",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppIndexFutures", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppIndexFutures_Exchanges_ExchangeId",
                        column: x => x.ExchangeId,
                        principalTable: "Exchanges",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppIndexOptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppIndexOptions_Exchanges_ExchangeId",
                        column: x => x.ExchangeId,
                        principalTable: "Exchanges",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppEquities_ExchangeId",
                table: "AppEquities",
                column: "ExchangeId");

            migrationBuilder.CreateIndex(
                name: "IX_AppEquityFutures_ExchangeId",
                table: "AppEquityFutures",
                column: "ExchangeId");

            migrationBuilder.CreateIndex(
                name: "IX_AppEquityOptions_ExchangeId",
                table: "AppEquityOptions",
                column: "ExchangeId");

            migrationBuilder.CreateIndex(
                name: "IX_AppETFs_ExchangeId",
                table: "AppETFs",
                column: "ExchangeId");

            migrationBuilder.CreateIndex(
                name: "IX_AppFyersCredentials_UserId",
                table: "AppFyersCredentials",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_AppIndexes_ExchangeId",
                table: "AppIndexes",
                column: "ExchangeId");

            migrationBuilder.CreateIndex(
                name: "IX_AppIndexFutures_ExchangeId",
                table: "AppIndexFutures",
                column: "ExchangeId");

            migrationBuilder.CreateIndex(
                name: "IX_AppIndexOptions_ExchangeId",
                table: "AppIndexOptions",
                column: "ExchangeId");
